...
const GAMES: GameTile[] = [
  ...
  },
  {
    id: 'fake-it',
    title: 'Fake It',
    description: 'Find the imposter who is drawing without knowing the topic!',
  ...
  },
  {
    id: 'bomb-disarm',
    title: 'Bomb Disarm',
    description: 'Rebels hide a bomb in the deck — cut 6 wires to disarm it before it blows!',
